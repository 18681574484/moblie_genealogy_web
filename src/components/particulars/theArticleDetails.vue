  ...
  <div class="introduction">
    ...
    <div class="article">
      <div class="articleConter">
        <h2>{{ culture.title }}</h2>
        <p>{{culture.content}}</p>
        <div :style="api.imgBG(culture.newsFaceUrl)" class="picture"></div>
      </div>
      ...
      <!-- 评论 -->
      <div class="comment">
        <img class="zi" src="@/assets/images/reward.png" alt>
        <h5>评论</h5>
    ...
    <div class="observer">
      ...
      <img class="pen" src="@/assets/images/pen.png" alt>
      <img class="shang" src="@/assets/images/shang.png" alt>
...
export default {
  ...
  methods: {
   article_get() {
      ...
      .then( res => {
        if(res.code == 200) {
          this.culture = res.data.records[0]
...
.introduction {
  ...
  .observer {
    ...
    border-top: 0.01rem solid #d0cfcf;
    box-sizing: border-box;
    input {
      outline: none;
      color: #666666;
